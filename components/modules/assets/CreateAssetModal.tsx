        ...
        >
          <View style={styles.sheet}>
            <View style={styles.header}>
              <Text style={styles.headerTitle}>Nuevo Asset</Text>
            ...
            >
              ...
              <View style={styles.section}>
                      ...
                      {(Object.keys(PARAMETER_TYPE_LABELS) as ParameterType[]).map((type) => (
                        ...
                        >
                          <Text
                            style={[
                              styles.typePillText,
                              param.type === type && styles.typePillTextActive,
                            ]}
                          >
                ...
                {parameters.length === 0 && (
                  <Text style={styles.emptyParams}>
                    Sin parámetros. Podés agregar después de crear el asset.
                  </Text>
                )}
              </View>
            </ScrollView>
            ...
            <View style={styles.footer}>
              {submitting ? (
                ...
                <Button label="Crear asset" onPress={handleSubmit} disabled={!canSubmit} />
              )}
            </View>
          </View>
        </KeyboardAvoidingView>
